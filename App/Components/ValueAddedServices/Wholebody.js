        ...
        <Container>
            <View style={{ ...styles.bannerIMG_view }}>
                <Image
                    ...
                    source={require('../../Assets/images/whole.jpg')}
                />
            </View>
            <Text style={{ fontFamily: FONTS.semibold, color: "#000", fontSize: moderateScale(20), paddingLeft: moderateScale(10) }}>Whole Body</Text>
            {data?.map((item, index) => {
                return (
