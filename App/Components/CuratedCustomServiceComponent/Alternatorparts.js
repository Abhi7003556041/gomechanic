...
const Alternatorparts = () => {
    ...
    return (
        <Container>
            ...
            <Text style={{ fontFamily: FONTS.semibold, color: "#000", fontSize: moderateScale(20), paddingLeft: moderateScale(10) }}>Alternator</Text>
            {/* ---------------------- */}
...
export default Alternatorparts
