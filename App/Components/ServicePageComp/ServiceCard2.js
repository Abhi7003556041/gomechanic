        ...
        <Container>
            <View style={{ ...styles.bannerIMG_view }}>
                <Image
                    ...
                    source={require('../../Assets/images/carbanner2.jpg')}
                />
            </View>
            <Text style={{ fontFamily: FONTS.semibold, color: "#000", fontSize: moderateScale(20), paddingLeft: moderateScale(10) }}>Brake Maintenance</Text>
            {data?.map((item, index) => {
                return (
